...
public class SunmiPrintHelper {
    ...
    public void ProcessEnterPrinterBuffer(){
        try {
            if (sunmiPrinterService == null) {
    ...
    public void ProcessCommitPrinterBuffer(InnerResultCallback mCallback){
        try {
            if (sunmiPrinterService == null) {
                //TODO Service disconnection processing
                return;
            ...
            if (mCallback!=null) {
                sunmiPrinterService.commitPrinterBufferWithCallback(mCallback);
            }
            else {
    ...
    public boolean CheckSunmiPrinterAvaiable(){
        boolean ret = false;
        ret = sunmiPrinter == FoundSunmiPrinter?true : false;
        return ret;
    }
    ...
    public void printImagefromBase64(String base64Image) {
        if (sunmiPrinterService == null) {
            //TODO Service disconnection processing
            return;
        }
        ...
        try {
            byte[] decodedByteArray = Base64.decode(base64Image, Base64.NO_WRAP);
            Bitmap decodedImage = BitmapFactory.decodeByteArray(decodedByteArray, 0, decodedByteArray.length);
            sunmiPrinterService.printBitmapCustom(decodedImage,1,null);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    public void printTextAlignLeft(String content, float size, boolean isBold) {
        if(sunmiPrinterService == null){
            //TODO Service disconnection processing
            return;
        }
    ...
    public void printTextAlignCenter(String content, float size, boolean isBold) {
        if(sunmiPrinterService == null){
            //TODO Service disconnection processing
            return;
        }
    ...
    public void printTextAlignRight(String content, float size, boolean isBold) {
        if(sunmiPrinterService == null){
            //TODO Service disconnection processing
            return;
        }
