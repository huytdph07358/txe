...
abstract class Translate {
  ...
  /// No description provided for @chucNang.
  ///
  /// In en, this message translates to:
  /// **'Screen'**
  String get chucNang;

  /// No description provided for @chucNangYeuThich.
  ///
  /// In en, this message translates to:
  /// **'Favourite screen'**
  String get chucNangYeuThich;

  /// No description provided for @themVaoYeuThich.
  ///
  /// In en, this message translates to:
  /// **'Add to favourite'**
  String get themVaoYeuThich;

  /// No description provided for @longtext_chuThich.
  ///
  /// In en, this message translates to:
  /// **'Luôn chỉ có 4 chức năng yêu thích. Việc thêm 1 chức năng mới sẽ đẩy 1 chức năng hiện có ra khỏi danh sách.'**
  String get longtext_chuThich;
