...
abstract class Translate {
  ...
  /// No description provided for @longtext_khongCoVaiTroTiketSeller.
  ///
  /// In en, this message translates to:
  /// **'You have not been declared as a bus ticket agent'**
  String get longtext_khongCoVaiTroTiketSeller;

  /// No description provided for @longtext_khongCoVaiTroSupervisor.
  ///
  /// In en, this message translates to:
  /// **'You need to be assigned the supervisor role to be able to use this feature'**
  String get longtext_khongCoVaiTroSupervisor;

  /// No description provided for @longtext_khongCoVaiTroRegister.
  ///
  /// In en, this message translates to:
  /// **'You need to be assigned a device registration role to be able to use this feature'**
  String get longtext_khongCoVaiTroRegister;

  /// No description provided for @longtext_khongCoVaiTroTester.
  ///
  /// In en, this message translates to:
  /// **'You need to be assigned the tester role to be able to use this feature'**
  String get longtext_khongCoVaiTroTester;
