...
abstract class Translate {
  ...
  /// No description provided for @tenDangNhap.
  ///
  ...
  /// No description provided for @phanMemDangTroVaoMoiTruongPhatTrien.
  ///
  /// In en, this message translates to:
  /// **'The software is connecting to the develop environment'**
  String get phanMemDangTroVaoMoiTruongPhatTrien;

  /// No description provided for @tongDaiHoTro.
  ///
  /// In en, this message translates to:
  /// **'Call center'**
  String get tongDaiHoTro;
