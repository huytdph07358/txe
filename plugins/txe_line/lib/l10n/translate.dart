...
abstract class Translate {
  ...
  /// No description provided for @tuyen.
  ///
  /// In en, this message translates to:
  /// **'Route'**
  String get tuyen;

  /// No description provided for @longtext_khongCoTuyenNao.
  ///
  /// In en, this message translates to:
  /// **'You are not assigned to any route to sell tickets.'**
  String get longtext_khongCoTuyenNao;
