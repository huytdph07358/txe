...
abstract class Translate {
  ...
  /// No description provided for @matKhauHienTai.
  ///
  /// In en, this message translates to:
  /// **'Current password'**
  String get matKhauHienTai;
  ...
  /// No description provided for @nhapLaiMatKhauMoi.
  ///
  /// In en, this message translates to:
  /// **'Confirm new password'**
  String get nhapLaiMatKhauMoi;

  /// No description provided for @khongKhopVoiMatKhauMoi.
  ///
  /// In en, this message translates to:
  /// **'Not match new password'**
  String get khongKhopVoiMatKhauMoi;
